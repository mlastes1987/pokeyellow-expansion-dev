...
pokeyellow-expansion-dev_obj       := $(rom_obj)
...
all: $(roms)
yellow:       pokeyellow-expansion-dev.gbc
...
$(foreach obj, $(pokeyellow-expansion-dev_obj), $(eval $(call DEP,$(obj),$(obj:.o=.asm))))
...
pokeyellow-expansion-dev_pad       = 0x00
